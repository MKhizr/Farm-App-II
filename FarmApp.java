    ...
    public static void main(String[] args) throws ParseException, IOException, ClassNotFoundException {
        ...
        while(Value != 27) {
            ...
            if (Value == 1) {
                ...
                System.out.println("Enter tag number of sheep you want to delete: ");
                //int tagNo = TagProvider();
                //deleteSheep(tagNo);
                ...
                System.out.println("Enter tag number of sheep you want details of: ");
                //int tagNo = TagProvider();
                ...
                System.out.println("Enter ID of farm worker you want to delete: ");
                //int farmworkerID = TagProvider();
                //deleteFarmworker(farmworkerID);
                ...
                System.out.println("Enter ID of farm worker you want details of: ");
                //int farmworkerID = TagProvider();
                //getFarmworkerDetails(farmworkerID);
                ...
                System.out.println("Enter ID of vet: ");
                //int vetID = TagProvider();
                System.out.println("Enter tag number of sheep: ");
                //int tagNo = TagProvider();
                //addSheepTreatment(vetID, tagNo);
                ...
                System.out.println("Enter tag number of sheep you want treatment of: ");
                //int tagNo = TagProvider();
                ...
                System.out.println("Enter tag number of animal you need feeding information about: ");
                //int tagNo = TagProvider();
                //feedingAnimal(tagNo);
            }
            else if(Value == 24){
                System.out.println("Enter employee ID of employee you need salary information about: ");
                //int empId = TagProvider();
                ...
                System.out.println("Enter tag number of animal: ");
                //int tagNo = TagProvider();
                System.out.println("Enter amount of milk: ");
                //double amount = input.nextDouble();

                //addMilkingMeasurements(tagNo,amount);

            }
            else if(Value == 26){

                System.out.println("Enter tag number of first employee: ");
                //int tagNo1 = TagProvider();
                System.out.println("Enter tag number of second employee: ");
                //int tagNo2 = TagProvider();

                //salaryComparator(tagNo1,tagNo2);
